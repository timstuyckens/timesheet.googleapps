(function() {
	...
	require(['ViewModel', 'gcalModule', 'knockout', 'jquery', 'navigatieModule', 'CalendarViewModel', 'SettingsViewModel', 'mapperModule', 'gdocsModule', 'moment'],
		function(ViewModel, GCalModule, ko, $, navigatieModule, CalendarViewModel, SettingsViewModel, mapper, gdocsModule, moment) {
